...
/**
 *  Scrolling utility class taken from: http://www.chka.de/
 */
...
public abstract class JTableScrolling {
    ...
    public static void makeColumnsVisible(JTable table, int first, int last) {
        Scrolling
                .scrollHorizontally(table, getColumnBounds(table, first, last));
    }
    ...
    public static void makeCellsVisible(JTable table, int firstRow,
            int lastRow, int firstColumn, int lastColumn) {
        table.scrollRectToVisible(getCellBounds(table, firstRow, lastRow,
    ...
    public static void centerColumn(JTable table, int column) {
        Scrolling.centerHorizontally(table, getColumnBounds(table, column),
                false);
    }

    public static void centerRows(JTable table, int first, int last) {
        Scrolling.centerVertically(table, getRowBounds(table, first, last),
                false);
    }
    ...
    public static void centerCells(JTable table, int firstRow, int lastRow,
    ...
    public static boolean isColumnVisible(JTable table, int column) {
        return Scrolling.isHorizontallyVisible(table, getColumnBounds(table,
                column));
    }
    ...
    public static boolean areRowsVisible(JTable table, int first, int last) {
        return Scrolling.isVerticallyVisible(table, getRowBounds(table, first,
                last));
    }
    ...
    public static boolean areCellsVisible(JTable table, int firstRow,
        ...
        return Scrolling.isVisible(table, getCellBounds(table, firstRow,
    ...
    private static void checkCells(JTable table, int firstRow, int lastRow,
            int firstColumn, int lastColumn) {
